...
describe("style", () => {
  ...
  it("replace !, [] and .", () => {
    expect(transformStyle(".\\!w-\\[200\\.5px\\] {}")).toBe(
      ".-i-w--200-d-5px- {}",
    );
  });
  ...
  it("replace [], (), ' and /", () => {
    expect(
      transformStyle(".bg-\\[url\\(\\'\\/img\\/grid\\.svg\\'\\)\\] {}"),
    ).toBe(".bg--url--q--s-img-s-grid-d-svg-q--- {}");
  });
  ...
  it("replace space-between", () => {
    expect(
      transformStyle(".space-x-0 > :not([hidden]) ~ :not([hidden]) {}"),
    ).toBe(
    ...
    expect(
      transformStyle(".space-x-reverse > :not([hidden]) ~ :not([hidden]) {}"),
    ).toBe(
  ...
  it("replace divide-width", () => {
    expect(
      transformStyle(".divide-x > :not([hidden]) ~ :not([hidden]) {}"),
    ).toBe(
    ...
    expect(
      transformStyle(".divide-x-reverse > :not([hidden]) ~ :not([hidden]) {}"),
    ).toBe(
  ...
  it("replace body", () => {
    ...
    expect(transformStyle(".uv-form-item__body {}")).toBe(
      ".uv-form-item__body {}",
    );
  });
  ...
  it("replace img", () => {
    expect(
      transformStyle("img,svg,video,canvas,audio,iframe,embed,object {}"),
    ).toBe("image,svg,video,canvas,audio,iframe,embed,object {}");
    expect(
      transformStyle(
    ...
    expect(
      transformStyle(".ql-container img{display:inline-block;max-width:100%}"),
    ).toBe(".ql-container img{display:inline-block;max-width:100%}");
  });

  it("replace a", () => {
    expect(transformStyle("a {}")).toBe(
  ...
  it("replace *", () => {
    ...
    expect(transformStyle(".\\*\\:rounded-full>* {}")).toBe(
      ".-w-_rounded-full>view,.-w-_rounded-full>button,.-w-_rounded-full>text,.-w-_rounded-full>image {}",
    );
  });

  it("replace unicode", () => {
    expect(transformStyle(".\\32xl\\:rounded-2xl {}")).toBe(
      ".xxl_rounded-2xl {}",
    );
